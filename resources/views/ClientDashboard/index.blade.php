...
<body class="bg-gray-50 min-h-screen">
    ...
    <section class="bg-purple-600 text-white py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-lg md:text-xl mb-8">Connect with top freelancers across various fields to get your projects done efficiently.</p>
            <a href="#" class="px-8 py-3 bg-white text-purple-600 font-semibold rounded-lg shadow-lg hover:bg-purple-100 transition">Post Job</a>
        </div>
    </section>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <a href="#" class="px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg shadow-lg hover:bg-purple-700 transition">Sign up and start posting jobs</a>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            <div class="bg-white p-6 rounded-lg shadow">
                <img src="https://s3-alpha.figma.com/hub/file/3476578704/8ccab158-e1af-40ad-9db2-cc7bb790665a-cover.png" alt="UI Design" class="w-30 h-30 mx-auto mb-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2T8bo2aBGIN0a89w1H33mHvM7_ihd2An2WQ&s" alt="Branding" class="w-30 h-30 mx-auto mb-4">
    ...
    <main class="flex flex-col md:flex-row mt-4 shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="md:w-1/2 relative overflow-hidden">
          ...
          <div id="slider" class="w-full h-full relative">
            ...
            <img class="slide absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-1000" src="https://storage.googleapis.com/a1aa/image/d5LWMIZvE1TRnJjDnj40aHV92_ag8qWilw7X-eQ67bs.jpg" alt="Slide 1">
            <img class="slide absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-1000" src="https://i.pinimg.com/474x/6a/34/d0/6a34d010360f9491540182d22b02dc4e.jpg" alt="Slide 2">
            <img class="slide absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-1000" src="https://i.pinimg.com/474x/07/9a/33/079a335f1db0691a229d01fa655f7df4.jpg" alt="Slide 3">
          </div>
        </div>
        ...
        <div class="md:w-1/2 bg-purple-600 text-white p-10 flex flex-col justify-center">
          ...
          <button class="mt-2 bg-white text-purple-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
            Find Opportunities
          </button>
        </div>
      </main>
