<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('https://example.com/your-background-image.jpg');">
        <div class="bg-black bg-opacity-70 rounded-lg shadow-lg p-8 max-w-sm w-full">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="email" class="block mt-1 w-full border border-gray-300 rounded-md p-2" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <x-primary-button class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 rounded-md ms-3">
                        {{ __('Sign In') }}
                    </x-primary-button>
                </div>
            </form>
